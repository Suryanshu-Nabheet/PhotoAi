  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        "gradient-dark":
          "linear-gradient(to bottom right, #000000, #0a0a0a, #0f172a)",
        "gradient-blue": "linear-gradient(135deg, #1e293b 0%, #0f172a 100%)",
        "gradient-card":
          "linear-gradient(135deg, rgba(15, 23, 42, 0.8) 0%, rgba(0, 0, 0, 0.9) 100%)",
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      boxShadow: {
        ...
        "glow-blue": "0 0 40px rgba(37, 99, 235, 0.8)",
      },
    },
  },
